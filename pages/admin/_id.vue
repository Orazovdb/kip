<template>
  <div class="admin">
    ...
    <div v-if="activeBtn === 1">
      <admin-about :activeLang="activeLang" />
    </div>
    <div v-else-if="activeBtn === 2">
      <admin-about-info :activeLang="activeLang" />
    </div>
    <div v-else>
      <admin-about-contact :datas="main" :activeLang="activeLang" />
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    changeButtonPage(key) {
      this.activeBtn = key;
      this.activeLang = "Tm";
      // this.$router.push(`/admin/${this.activeBtn}`);
    },
  },
};
</script>
